...
def xml_handle_doc(obj, value: str | list, line_number=None, line_loc=None):
...
def helper_keyword_type(keyword_type):
    """
...
def validate_field_attribute_and_value(v_attr, v_val, allowed_attribute, value):
    """
